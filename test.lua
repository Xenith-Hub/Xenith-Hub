...
function PerceptionESP.AddCustomEntity(Entity, Options)
    ...
    RenderConnection = Services.RunService.RenderStepped:Connect(function()
        ...
        if not Maid.ESPController or not PerceptionESP.CurrentSettings then
            for _, Object in pairs(ESPObject) do
                if typeof(Object) == "Instance" and Object:IsA("GuiObject") then
                    Object.Visible = false
                elseif typeof(Object) == "table" then
                    for _, SubObject in pairs(Object) do
                        if typeof(SubObject) == "Instance" and SubObject:IsA("GuiObject") then
        ...
        local Settings = PerceptionESP.CurrentSettings
        ...
        if OnScreen then
            ...
            if Options.ShowName and ESPObject.Name then
                ...
                ESPObject.Name.Visible = Settings.ShowName
            end

            if Options.ShowBoxes and ESPObject.Box then
                ESPObject.Box.Visible = Settings.ShowBoxes
                if Settings.ShowBoxes then
                    ...
                    ESPObject.LeftTop.Size = UDim2.new(0, Width / 5, 0, Settings.BoxLineWidth)
                    ...
                    ESPObject.LeftSide.Size = UDim2.new(0, Settings.BoxLineWidth, 0, Height / 5)
                    ...
                    ESPObject.RightTop.Size = UDim2.new(0, Width / 5, 0, Settings.BoxLineWidth)
                    ...
                    ESPObject.RightSide.Position = UDim2.new(0, Position.X + Width / 2 - Settings.BoxLineWidth, 0, Position.Y - Height / 2)
                    ESPObject.RightSide.Size = UDim2.new(0, Settings.BoxLineWidth, 0, Height / 5)
                    ...
                    ESPObject.BottomSide.Size = UDim2.new(0, Settings.BoxLineWidth, 0, Height / 5)
                    ...
                    ESPObject.BottomDown.Size = UDim2.new(0, Width / 5, 0, Settings.BoxLineWidth)
                    ...
                    ESPObject.BottomRightSide.Size = UDim2.new(0, Settings.BoxLineWidth, 0, Height / 5)
                    ...
                    ESPObject.BottomRightDown.Size = UDim2.new(0, Width / 5, 0, Settings.BoxLineWidth)
                    ESPObject.BottomRightDown.AnchorPoint = Vector2.new(1, 1)
                else
                    ESPObject.LeftTop.Visible = false
                    ESPObject.LeftSide.Visible = false
                    ESPObject.RightTop.Visible = false
                    ESPObject.RightSide.Visible = false
                    ESPObject.BottomSide.Visible = false
                    ESPObject.BottomDown.Visible = false
                    ESPObject.BottomRightSide.Visible = false
                    ESPObject.BottomRightDown.Visible = false
                end
            end

            if Options.ShowChams and ESPObject.Chams then
                ESPObject.Chams.Enabled = Settings.ShowChams
            ...
            if Options.ShowHealthbar and ESPObject.Healthbar then
                ...
                if Humanoid and Settings.ShowHealthbar then
            ...
            if Options.ShowTracers and ESPObject.Tracer then
                if Settings.ShowTracers then
                    ...
                    ESPObject.Tracer.Size = UDim2.new(0, Settings.TracerThickness, 0, TracerDistance)
                ...
                if Settings.ShowHeadDots then
                    ...
                    if HeadPosition then
                        ...
                        if HeadOnScreen then
                            ...
                            ESPObject.HeadDot.Size = UDim2.new(0, Settings.HeadDotSize, 0, Settings.HeadDotSize)
                        else
